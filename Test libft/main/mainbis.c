...
/*   Updated: 2014/11/15 22:06:10 by fbarillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				uf_test_atoi(void)
{
	...
	if (atoi("+9223372036854775808") != ft_atoi("+9223372036854775808"))
		D_ERROR
	if (atoi("+9223372036854775818") != ft_atoi("+9223372036854775818"))
		D_ERROR
	if (atoi("") != ft_atoi(""))
		D_ERROR
	i = 0;
...
int				uf_test_strncmp(void)
{
	...
	if (a)
		D_ERROR;
#endif
	a = ft_strncmp("\200", "\0", 2);
#ifdef  __clang__
	if (strncmp("\200", "\0", 2) != a)
		D_ERROR;
#endif
	return (1);
}
...
int				uf_test_strnstr(void)
{
	...
	if (strnstr("abababeba", "ababeba", 8) != ft_strnstr("abababeba", "ababeba", 8))
		D_ERROR;
...
int				uf_test_strstr(void)
{
	...
	if (strstr("abababeba", "ababeba") != ft_strstr("abababeba", "ababeba"))
		D_ERROR;
